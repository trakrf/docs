...
Place this above "Deferred work" because it's a _state observation with future fix_, not a _deferred work item with a trigger_ — distinct from the existing Deferred-work entries which have explicit revisit triggers tied to external events.
