...
- A TrakRF account. If you were given preview credentials, you already have one — skip to step 1. Otherwise <EnvSignInLink>sign up at the <EnvLabel /> app</EnvSignInLink>.
